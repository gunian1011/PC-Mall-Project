          ...
          <tbody>
            ...
            <tr v-for="goods in $store.getters['cart/validList']" :key="goods.skuId">
              ...
              <td class="tc">
                ...
                <p v-if="goods.price-goods.nowPrice">比加入时降价 <span class="red">&yen;{{goods.price-goods.nowPrice}}</span></p>
              </td>
              <td class="tc">
...
import CartSku from './compoents/cart-sku.vue'
import { useStore } from 'vuex'
import { useRouter } from 'vue-router'
import Message from '@/components/library/Message'
// import XtxConfirm from '@/components/library/xtx-confirm'
import CartNone from './compoents/cart-none.vue'
...
export default {
  ...
  setup () {
    ...
    const batchDeleteCart = (isClear) => {
      Confirm({ text: `您是否确认删除${isClear ? '失效' : '选中'}的商品` }).then(() => {
